...
public class DataTransFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    return inflater.inflate(R.layout.btooth_layout_data_trans, container, false);
  }
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    dataListAdapter = new ArrayAdapter<String>(getContext(), R.layout.btooth_layout_item_new_data);
